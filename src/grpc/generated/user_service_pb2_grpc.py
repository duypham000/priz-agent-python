...
from src.grpc.generated import user_service_pb2 as user__service__pb2
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__service__pb2.UserInfo.SerializeToString,
            ),
            'GetUserContext': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUserContext,
                    request_deserializer=user__service__pb2.GetUserContextRequest.FromString,
                    response_serializer=user__service__pb2.UserExecutionContext.SerializeToString,
            ),
            'ListActiveUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.ListActiveUsers,
                    request_deserializer=user__service__pb2.ListActiveUsersRequest.FromString,
                    response_serializer=user__service__pb2.ListActiveUsersResponse.SerializeToString,
            ),
    }
